...
export default function ListingDetail({ listing }: {
    ...
    return (<div className="max-w-4xl mx-auto">
      <div className="card p-6 sm:p-8 mb-6">
        <div className="flex flex-col sm:flex-row gap-6">
          <div className="shrink-0">
            {listing.photo_url ? (<div className="relative h-32 w-32 rounded-2xl overflow-hidden bg-mist-200">
                <Image src={listing.photo_url} alt={displayName} fill className="object-cover" sizes="128px"/>
              </div>) : (<div className="flex h-32 w-32 items-center justify-center rounded-2xl bg-sky-100 text-sky-600 text-4xl font-serif font-bold">{displayName.charAt(0)}</div>)}
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
        {specialties.length > 0 && (<div className="card p-6">
      ...
      {(listing.phone || listing.email || listing.website) && (<div className="card p-6 mb-6">
      ...
      {languages.length > 0 && (<div className="card p-6 mb-6">
      ...
      {!listing.claimed && (<div className="rounded-2xl bg-sky-50 border border-sky-200 p-6 mb-6">
          <h3 className="font-serif text-lg font-semibold text-slate-800 mb-2">Is this your listing?</h3>
          <p className="text-sm text-slate-600 mb-4"> Listings are free. Public contact details are available without payment. </p>
