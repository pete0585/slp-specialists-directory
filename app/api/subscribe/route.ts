...
const NICHE = 'slp-specialists' as const
const NEWSLETTER_NAME = 'The SLP Signal' as const
const CONFIRM_URL_BASE = 'https://www.slpspecialistsdirectory.com/newsletter/confirm'
