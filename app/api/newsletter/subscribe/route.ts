...
const NICHE = 'slp' as const
const DIRECTORY_SLUG = 'slp-specialists-directory' as const
const NEWSLETTER_NAME = 'The Communication Footnote' as const
const CONFIRM_URL_BASE = 'https://www.findslpspecialist.com/newsletter/confirm'
