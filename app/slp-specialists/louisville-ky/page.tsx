...
export default async function CityPage() {
  ...
  const faqLd = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How many speech-language pathologist are in Louisville, KY?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Speech-Language Pathologist Directory lists 32+ speech-language pathologist in Louisville, Kentucky. Counts change as new listings are seeded.",
        },
      },
      {
        "@type": "Question",
        name: "How do I find speech-language pathologist in Louisville?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Search findslpspecialist.com and filter by Louisville. Compare listed providers, then contact the one that fits.",
        },
      },
    ],
  }
    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 py-10">
        ...
        <p className="mt-3 max-w-2xl text-neutral-600">
          32+ listed speech-language pathologist in the Louisville area. Pages are generated from live directory listings — not outreach.
        </p>
